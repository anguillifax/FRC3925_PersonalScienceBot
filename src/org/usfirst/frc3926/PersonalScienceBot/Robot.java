...
import org.usfirst.frc3926.PersonalScienceBot.commands.AutonomousCommand;
import org.usfirst.frc3926.PersonalScienceBot.commands.LogAHRS;
import org.usfirst.frc3926.PersonalScienceBot.commands.ManualDrive;
import org.usfirst.frc3926.PersonalScienceBot.commands.Pivot;
import org.usfirst.frc3926.PersonalScienceBot.commands.TrapMove;
import org.usfirst.frc3926.PersonalScienceBot.helpers.CameraMovieWriter;
...
public class Robot extends IterativeRobot {
	...
	// "The domino that breaks the tree"
	//				  -Kyle Eidson 2015
	Command trapezoidalDrive;
	Command cameraMovieWriter;
	...
	public void robotInit() {
		...
		LiveWindow.addSensor("Robot", "Camera", navx);
		
		autonomousCommand = new AutonomousCommand();
		manualDrive = new ManualDrive();
		logAhrs = new LogAHRS();
		pivotCommand = new Pivot(180, 10, 0, 60);
		trapezoidalDrive = new TrapMove();
		cameraMovieWriter = new CameraMovieWriter();
		
		XboxHelper.init();
		logAhrs.start();
		cameraMovieWriter.start();
	}
